...
# [Structured output (JSON schema)] [Hallucination] [Chain-of-Thought (CoT)]
# RESPONSE_SCHEMA is the fixed contract for every answer produced by this system.
# Do not add or remove fields without updating validate_response and README.
...
def validate_response(payload):
    """Validate a response dict against RESPONSE_SCHEMA; return list of error strings."""
    try:

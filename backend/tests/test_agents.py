from legal_assistant.agent.legal_agent import LegalAgent, compare_strategies, run_fixed_workflow
...
def test_agent_has_safe_step_budget(monkeypatch):
    monkeypatch.setattr("legal_assistant.agent.legal_agent.retrieve", lambda *args, **kwargs: [])
